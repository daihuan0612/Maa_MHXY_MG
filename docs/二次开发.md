...
6. 发版您的版本
    ...
    git tag v1.6.2-beta.3
    git push origin v1.2.3-beta.1

    git tag  -a v1.6.2 -m "[已有 Mirror酱 CDK？点击前往高速下载](https://mirrorchyan.com/zh/projects?rid=Maa_MHXY_MG)"
    ...
    git -c http.sslVerify=false push origin v1.6.2
